...
#### ch01 — [快速入门](ch01/index.md) 
- [x] 知识点 1：命令式编程
- [x] 知识点 2：编译型语言
- [x] 知识点 3：编译器是朋友

#### ch02 — [程序的基本结构](ch02/index.md) 
- [x] 知识点 1：语法（Grammar）
...
#### ch05 — [基本值与数据](ch05/index.md) 
- [x] 知识点 1-9：类型系统（抽象状态机、基本类型、语义类型、窄类型提升、字面量、隐式转换、初始化器）
- [x] 知识点 10-18：二进制表示（命名常量、复合字面量、位运算、移位、补码、定宽类型、_BitInt、浮点表示）
