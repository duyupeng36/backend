...
- 📖 《Modern C》第 1 章（Getting Started，对应中文版 `books/chapters/ch01-GettingStarted-zh.md`）+ K&R 第 1~2 章（辅助）
- ✍️ 练习：用 C 重写 3 个你熟悉的 Python 小脚本，感受类型声明和编译
